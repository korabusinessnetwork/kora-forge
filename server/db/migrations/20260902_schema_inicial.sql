-- 20260902_schema_inicial
-- Espelha docs/04_MODELAGEM/schema.sql, que é a fonte de verdade. A tabela schema_migrations
-- é criada pelo migrador. Sem PRAGMA aqui: a conexão liga foreign_keys e WAL (server/db/conexao.js).
