# ADR-010, Serialização de layout do Studio

**Status**: Proposto
**Data**: 2026-09-09
**Decisores**: Matheus Bonato
**Supersede**: nenhum. Cumpre a pendência que o ADR-005 deixou escrita nas notas de implementação,
e **interpreta** uma frase dele, na seção "A leitura de DOM absoluto"
